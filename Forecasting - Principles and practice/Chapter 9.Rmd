...
for(num in 1:5) {
  retail_tslm <- tslm(myts ~ trend + t_pw_1 + t_pw_2 + fourier(retail_bc, K = num), lambda = retail_lambda)
...
map2(list(retail_fit1, retail_fit2, retail_fit3, retail_fit4, retail_fit5), list(retail_test, retail_test, retail_test,retail_test, retail_test), accuracy)
